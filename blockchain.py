...
def main():
    ...
    print("Time after mine: ", datetime.now() - start, "s")
    print("the blockchain is", blockchain.isValid())
    print("Time taken after check: ", datetime.now() - start, "s")
